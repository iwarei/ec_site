        ...
        <div class="flex flex-1 justify-end items-center px-2 lg:px-0">
          <div class="max-w-lg w-full lg:max-w-xs">
            ...
            <form methode="get" action="/search" class="relative z-50">
              ...
              <input type="text" name="search" id="s" class="block w-full pl-10 pr-3 py-2 border border-transparent rounded-md leading-5 bg-indigo-100 text-gray-300 placeholder-gray-400 focus:outline-none focus:bg-white focus:text-gray-900 sm:text-sm transition duration-150 ease-in-out" placeholder="検索">
            </form>
          </div>
          ...
          <div class="hidden lg:block lg:ml-2">
            <div class="flex">
              @auth
                <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-indigo-50 no-underline font-semibold hover:bg-indigo-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> カート </a>
                <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-indigo-50 no-underline font-semibold hover:bg-indigo-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> 注文履歴 </a>
                <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-indigo-50 no-underline font-semibold hover:bg-indigo-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> マイページ </a>
                <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-indigo-50 no-underline font-semibold hover:bg-indigo-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> ログアウト </a>
              @else
                <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-indigo-50 no-underline font-semibold hover:bg-indigo-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> カート </a>
                <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-indigo-50 no-underline font-semibold hover:bg-indigo-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> 会員登録 </a>
                <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-indigo-50 no-underline font-semibold hover:bg-indigo-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> ログイン </a>
              @endauth
            </div>
          </div>
        </div>
