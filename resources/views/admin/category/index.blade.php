    ...
    <div class="sm:flex sm:items-center sm:justify-between">
      <div>
        <div class="flex items-center gap-x-3">
          ...
          <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">親カテゴリ : {{ count($categories) }}</span>
        </div>
  
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">登録されているカテゴリ一覧（親カテゴリ）です。</p>
      </div>
          ...
          @endif
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td class="px-6 py-4 text-right">
                    <a href="{{ route('admin.category.show', $category) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">詳細</a>
                  </td>
                </tr>
