  ...
  <div class="px-3 pb-4">
    ...
    @if (!$showSimple)
      ...
      <div class="flex items-center justify-between mt-2">
        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-25 text-center dark:bg-blue-600     dark:hover:bg-bluedark:focus:ring-blue-800">カートに入れる</button>
      </div>
    @endif
  </div>
</div>
